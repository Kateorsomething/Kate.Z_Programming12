...
//        System.out.println("Moving at " + e.getX() + "," +  e.getY() );
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        //select a random location and paint 100x.
        for (int i=0 ; i < 100 ; i++) {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        //select a random colume, and paint the entire colume white
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        //clear grid & colour the entire top half of the grid white, and the bottom half black
        clearGrid();
        for (int c = 0 ; c < gridCount ; c++) {
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        //count the # of white squares and display with textInfo.setText( Integer.toString(count) );
        int count = 0;
        for (int c = 0 ; c < gridCount ; c++) {
            for (int r = 0 ; r < gridCount ; r++) {
                if (grid[c][r] == 1) {
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        //invert the grid: black ->white & white -> black
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        //make any black square touching 2 white squares turn white. consider all 8 surrounding blocks
        //omg isnt this like Conway's game of life
        int[][] temp = new int[gridCount][gridCount];
        for (int c = 0 ; c < gridCount ; c++) {
            for (int r = 0 ; r < gridCount ; r++) {
                if (grid[c][r] == 0) {
                    if (countNeighbors(c,r) == 2) {
                        temp[c][r] = 1;
                    }
                }
            }
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        //all squares move 1 colum to the left
        int[][] temp = new int[gridCount][gridCount];
        for (int c = 0 ; c < gridCount ; c++) {
            for (int r = 0 ; r < gridCount ; r++) {
                if (c == 0) {
    ...
    public void test() {
        grid[1][1] = 1;
        grid[3][1] = 1;
        System.out.println("uh  " + countNeighbors(2,1));
    }
