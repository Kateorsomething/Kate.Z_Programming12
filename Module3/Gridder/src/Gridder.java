...
public class Gridder extends javax.swing.JFrame 
    ...
    public boolean isAlive(int c, int r) {
        if (c >= gridCount || c < 0 || r >= gridCount || r < 0) {
            return false;
        }
        if (grid[c][r] == 1) {
            return true;
    ...
    /**
     *randomly paint a square white 100x (same square can be painted twice)
     */
    ...
    /**
     * clear grid & paint top half of grid white
     */
    ...
    /**
     * count & display number of white squares
     */
    ...
    /**
     * any black square with 2 neighbouring white squares turn white
     * also omg isn't this like Conway's game of life
     */
    ...
    /**
     * move grid 1 column to the left
     */
